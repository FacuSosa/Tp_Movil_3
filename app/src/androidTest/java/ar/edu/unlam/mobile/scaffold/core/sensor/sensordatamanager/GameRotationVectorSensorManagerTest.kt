...
@SmallTest
class GameRotationVectorSensorManagerTest {
    ...
    lateinit var gameRotationSensorManager: GameRotationVectorSensorManager
    ...
    fun setUp() {
        ...
        gameRotationSensorManager = GameRotationVectorSensorManager(sensorManager)
    }

    @After
    fun tearDown() {
        gameRotationSensorManager.cancel()
    }

    @Test
    fun whenCollectingFlowFromGetSensorDataItMustEmitFiniteNumbers() = runTest {
        gameRotationSensorManager.getSensorData().test {
