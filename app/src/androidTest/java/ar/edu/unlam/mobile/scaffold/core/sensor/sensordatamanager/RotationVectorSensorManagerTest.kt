...
@SmallTest
class RotationVectorSensorManagerTest {
    ...
    lateinit var rotationVectorSensorManager: RotationVectorSensorManager
    ...
    fun setUp() {
        ...
        rotationVectorSensorManager = RotationVectorSensorManager(sensorManager)
    }

    @After
    fun tearDown() {
        rotationVectorSensorManager.cancel()
    }

    @Test
    fun whenCollectingFlowFromGetSensorDataItMustEmitFiniteNumbers() = runTest {
        rotationVectorSensorManager.getSensorData().test {
